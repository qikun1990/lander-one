...
function setSecondary() {
    "tar" == jQuery("body").data("type") && 0 < jQuery("[data-igeneric]").length && (jQuery(".img-primary").remove(), jQuery(".img-secondary").removeClass("p_hidden"), jQuery("[data-igeneric]").each(function() {}), jQuery("[data-cgeneric]").each(function() {
